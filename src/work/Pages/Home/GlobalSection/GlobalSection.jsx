        ...
        <div className="mx-10 md:mx-0">
          <div className="bg-[#0041f0] w-full lg:w-[42%] h-[330px] mt-10 lg:mt-[10%] lg:ml-[29%] relative customGlobalDiv2">
            ...
            <div className="div2 text-[17px] px-5 pt-5 bg-[#0041f0]">
              ...
              <p className="font-semibold mt-1">
                Every day, Julie and all of us at Bradley Reporting help the
                world’s leading companies embrace continuous reinvention, with
                innovation and people at the center.
              </p>
