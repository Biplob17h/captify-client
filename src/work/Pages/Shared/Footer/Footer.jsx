            ...
            <div className="container mx-auto flex flex-wrap justify-around items-start  ">
              ...
              <div className="w-full md:w-1/3 ">
                <div className="flex flex-col space-y-2">
                  <Link
                    href="#"
                    className="hover-underline-animation w-[130px]"
                  >
                    Privacy Statement
                  </Link>
                  <Link
                    href="#"
                    className="hover-underline-animation w-[145px]"
                  >
                    Terms & Conditions
                  </Link>
                  <Link
                    href="#"
                    className="hover-underline-animation w-[160px]"
                  >
                    Cookie Policy/Settings
                  </Link>
                  <Link
                    href="#"
                    className="hover-underline-animation w-[164px]"
                  >
